...
///
/// This page fetches the main categories from Firestore filtered by the
/// currently selected language. For each category, it then listens to the
/// corresponding `books` collection and shows a horizontally scrollable row
/// of book thumbnails. Administrators see a floating action button that
