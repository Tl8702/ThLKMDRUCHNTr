...
/// Displays a list of videos within a specific subcategory.
///
/// Users can view videos associated with the provided `subCategoryId`. If the
/// current user has administrative privileges, they can also add a new video
/// via a dialog. Videos are stored in the `videos` collection and filtered by
/// `subCategoryId` and language.
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return ListTile(
                ...
                title: Text(title),
                onTap: () {
                  // TODO: Navigate to video player and comments page.
                },
              );
            },
          );
